 ...
 * @hide
 */
public class RVCMenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    public RVCMenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false);
    }

    public RVCMenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenu) {
        if (subMenu.hasVisibleItems()) {
            RVCMenuPopupHelper subPopup = new RVCMenuPopupHelper(mContext, subMenu, mAnchorView, false);
